...
import type Expedition from '../../src/modules/expedition'
import type Province from '../../src/modules/province'
import type WaterproNotification from '../../src/modules/notification-custom'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'expedition': InstanceType<(typeof Expedition)['service']>,
    'province': InstanceType<(typeof Province)['service']>,
    'waterproNotification': InstanceType<(typeof WaterproNotification)['service']>
  }
}